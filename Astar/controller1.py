...
class node:
	'''
		...
		where   x is the x -cordinate
				...
				f is the f(n) which is equal to h(n) + g(n) for A* search method
				h(n) is the heuristic function which is equal to manhettan distance and it is admissible heuristic function
